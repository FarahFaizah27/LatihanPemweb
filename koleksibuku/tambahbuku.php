<!DOCTYPE html>
 ...
 <!-- Bootstrap CSS -->
    ...
    <body>
        ...
        <a href="indexcreateurut.php" class="btn btn-primary mb-1 mt-1 ml-0"><i class="fas fa-user-plus mr-0"></i>Koleksi Buku</a>
        <button type="submit" class="btn btn-success mb-1 mt-1 ml-0 mr-0" >Kirim</button>
    </form>
 <!-- Optional JavaScript -->
